...
class Zipcode extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'local_public_entity_code' => Yii::t('app', 'Local Public Entity Code'),
            'old_zip_code' => Yii::t('app', 'Old Zip Code'),
            'zip_code' => Yii::t('app', 'Zip Code'),
            'prefecture_name_kana' => Yii::t('app', 'Prefecture Name Kana'),
            'city_ward_town_village_name_kana' => Yii::t('app', 'City Ward Town Village Name Kana'),
            'town_area_name_kana' => Yii::t('app', 'Town Area Name Kana'),
            'prefecture_name_kanji' => Yii::t('app', 'Prefecture Name Kanji'),
            'city_ward_town_village_name_kanji' => Yii::t('app', 'City Ward Town Village Name Kanji'),
            'town_area_name_kanji' => Yii::t('app', 'Town Area Name Kanji'),
            'multiple_zip_code' => Yii::t('app', 'Multiple Zip Code'),
            'has_banchi' => Yii::t('app', 'Has Banchi'),
            'has_chome' => Yii::t('app', 'Has Chome'),
            'multiple_town_area' => Yii::t('app', 'Multiple Town Area'),
            'modified' => Yii::t('app', 'Modified'),
            'modified_reason' => Yii::t('app', 'Modified Reason'),
        ];
    }
